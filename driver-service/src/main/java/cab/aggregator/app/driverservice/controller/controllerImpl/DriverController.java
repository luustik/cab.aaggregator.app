...
public class DriverController {
    ...
    public List<DriverResponseDto> getAllDrivers(@PathVariable String gender) {
    ...
    public DriverResponseDto createDriver(@Validated(OnCreate.class) @RequestBody DriverRequestDto requestDto) {
    ...
    public DriverResponseDto updateDriver(@PathVariable int id,
                                          @Validated(OnUpdate.class) @RequestBody DriverRequestDto requestDto) {
