...
public interface RideController {
    ...
    RideContainerResponse getAllRidesByDriverId(@Valid @Validated Long driverId);

    @Operation(summary = "Get all rides by passenger id")
    RideContainerResponse getAllRidesByPassengerId(@Valid @Validated Long passengerId);
